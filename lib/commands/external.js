...
ExternalCommand.prototype.getLevel = function() {
...
ExternalCommandList.prototype.retrieveAllCommands = function(callback) {
	this.db.collection('commands').find({$or: [{user: this.user._id}, {user: this.globalUser._id}]}).toArray(function(error, commands) {
